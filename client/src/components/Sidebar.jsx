...
const Sidebar = ({
  ...
  const { pathname } = useLocation(); //will determine which one we are currently on
    ...
    <Box>
      {isSideBarOpen && (
        ...
        >
            ...
            <Box m="1.5rem 2rem 0.5rem 3rem">
              <FlexBetween color={theme.palette.secondary.main}>
                <Box display="flex" onClick={handleNavigate}>
                  <ImageListItem>
                    <img
                      src={mode === "dark" ? iconWhite : iconBlack}
                      alt="iconWhite"
                      // loading="lazy"
                    />
                  </ImageListItem>
          ...
          <Box position={isNonMobile ? "relative" : "absolute"} bottom="0.7rem">
            <Divider />
